                ...
                >
                  ...
                  <div className="divide-y divide-gray-100">
                    <div className="flex items-center justify-between px-4 py-2">
                      <span className="text-xs text-gray-500">{translations.labels.income}</span>
                      <span className="text-sm font-medium text-emerald-600">
                        {formatCurrency(data.income)}
                      </span>
                    </div>
                    <div className="flex items-center justify-between px-4 py-2">
                      <span className="text-xs text-gray-500">{translations.labels.expenses}</span>
                      <span className="text-sm font-medium text-red-500">
                        {formatCurrency(data.expenses)}
                      </span>
                    </div>
                    <div className="flex items-center justify-between px-4 py-2 bg-white">
                      <span className="text-xs font-semibold text-gray-700">{translations.labels.balance}</span>
                      <span className={`text-sm font-bold ${getBalanceColorClass(data.balance)}`}>
