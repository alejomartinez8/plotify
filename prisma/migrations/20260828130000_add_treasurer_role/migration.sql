-- AlterTable
ALTER TABLE "contributions" ADD COLUMN     "approvalStatus" TEXT NOT NULL DEFAULT 'pending',
ADD COLUMN     "approvalNote" TEXT,
ADD COLUMN     "approvedBy" TEXT,
ADD COLUMN     "approvedAt" TIMESTAMP(3);

-- AlterTable
ALTER TABLE "expenses" ADD COLUMN     "approvalStatus" TEXT NOT NULL DEFAULT 'pending',
ADD COLUMN     "approvalNote" TEXT,
ADD COLUMN     "approvedBy" TEXT,
ADD COLUMN     "approvedAt" TIMESTAMP(3);
...
-- CreateIndex
CREATE UNIQUE INDEX "treasurers_email_key" ON "treasurers"("email");

-- CreateIndex
CREATE INDEX "approval_history_recordType_recordId_idx" ON "approval_history"("recordType", "recordId");
